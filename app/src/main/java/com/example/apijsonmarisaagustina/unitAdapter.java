...
import java.util.ArrayList;
 ...
 public class unitAdapter extends ArrayAdapter {
     Context context;
     ArrayList<unitActivity> datas = new ArrayList();
     LayoutInflater layoutInflater;

     ImageView img;
     TextView title, lateVersi, dev, website, description;

     public unitAdapter(Context context, ArrayList<unitActivity> data) {
         super(context, R.layout.unit, data);
     ...
     public View getView(int position, View convertView, ViewGroup parent) {
         convertView = layoutInflater.inflate(R.layout.unit, parent, false);
         unitActivity data = datas.get(position);
